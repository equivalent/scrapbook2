...
website build in Wordpress. Although I was a PHP developer for few years before I swithed to Ruby, I've never worked with WordPress.
...
I was told that good practictice in WordPress project is just to
deploy changes of a template (in our case `wp-content/themes/mytheme`).
...
General` and copy `SSH public key` for the project to your clipboard. We will need to paste this SSH key to VM (EC2 server). 
